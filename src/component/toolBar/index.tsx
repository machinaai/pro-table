...
const getButtonText = <T, U = {}>({
  ...
  fullScreen: {
    text: intl.getMessage('tableToolBar.fullScreen', 'full screen'),
    icon: <FullScreenIcon />,
  },
  reload: {
    text: intl.getMessage('tableToolBar.reload', 'Refresh'),
    icon: <ReloadOutlined />,
  },
  setting: {
    text: intl.getMessage('tableToolBar.columnSetting', 'Column settings'),
    icon: <SettingOutlined />,
  },
  density: {
    text: intl.getMessage('tableToolBar.density', 'Table density'),
    icon: <DensityIcon />,
  },
});
